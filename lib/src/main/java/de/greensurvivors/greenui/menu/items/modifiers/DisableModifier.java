...
public class DisableModifier<E extends BasicMenuItem> extends BasicModifier<E> implements Cloneable {
    ...
    public DisableModifier(@NotNull MenuManager manager, @NotNull E menuItem) {
        this(manager, menuItem, true);
    }

    public DisableModifier(@NotNull MenuManager manager, @NotNull E menuItem, boolean activeAtStart) {
